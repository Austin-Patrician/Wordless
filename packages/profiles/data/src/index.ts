...
export const dataProfile: ProfileDefinition = {
  ...
  activeToolNames: ["read", "bash", "edit", "write", "grep", "find", "ls", "data_catalog", "data_inspect", "data_materialize", "data_validate", "data_publish", "research_prepare", "research_start", "research_snapshot", "research_submit_dimension", "research_review_dimension", "research_validate", "research_delegate", "browser_tabs", "browser_snapshot", "browser_console", "browser_screenshot", "browser_click", "browser_type", "browser_press"],
