...
const wordlessBridge: DesktopBridge = {
  ...
  createAndPrompt: (draft, parts, submission, attachments) => ipcRenderer.invoke("wordless:session:create-and-prompt", { draft, parts, submission, attachments }),
  promptSession: (sessionId, parts, submission, attachments) => ipcRenderer.invoke("wordless:session:prompt", { sessionId, parts, submission, attachments }),
