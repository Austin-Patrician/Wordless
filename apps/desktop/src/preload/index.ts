...
const wordlessBridge: DesktopBridge = {
  ...
  createAutomation: (input) => ipcRenderer.invoke("wordless:automation:create", { input }),
  updateAutomation: (id, input) => ipcRenderer.invoke("wordless:automation:update", { id, input }),
  setAutomationsEnabled: (ids, enabled) => ipcRenderer.invoke("wordless:automation:set-enabled", { ids, enabled }),
  deleteAutomations: (ids) => ipcRenderer.invoke("wordless:automation:delete", { ids }),
  runAutomation: (id) => ipcRenderer.invoke("wordless:automation:run", { id }),
  listAutomationRuns: (limit) => ipcRenderer.invoke("wordless:automation:runs", { limit }),
  deleteAutomationRun: (id) => ipcRenderer.invoke("wordless:automation:run-delete", { id }),
  ...
  getDataAnalysisCapabilities: () => ipcRenderer.invoke("wordless:analysis:capabilities"),
  getAnalysisSnapshot: (sessionId) => ipcRenderer.invoke("wordless:analysis:snapshot", { sessionId }),
  openAnalysisOutput: (sessionId, analysisId, path) => ipcRenderer.invoke("wordless:analysis:open", { sessionId, analysisId, path }),
  revealAnalysisOutput: (sessionId, analysisId, path) => ipcRenderer.invoke("wordless:analysis:reveal", { sessionId, analysisId, path }),
  ...
  discoverProviderModels: (request) => ipcRenderer.invoke("wordless:model-config:discover-models", request),
  saveProviderConfiguration: (kind, providerId, configuration, enabledModelIds) => ipcRenderer.invoke("wordless:model-config:save-provider", { kind, providerId, configuration, ...(enabledModelIds ? { enabledModelIds } : {}) }),
