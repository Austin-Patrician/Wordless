...
const FAMILY_RULES: FamilyRule[] = [
  ...
  { pattern: /\b(kimi|moonshot)\b/i, id: "moonshot", label: "Kimi / Moonshot", avatarId: "kimi" },
...
export function modelPresentation(model: Pick<ProviderModelCandidate, "id" | "name" | "ownedBy">): Omit<ProviderModelGroup, "models"> {
  ...
  if (namespace) return { id: namespace.toLowerCase(), label: namespace, avatarId: family?.avatarId ?? null };
