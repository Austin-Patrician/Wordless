...
export function Composer({
  ...
  const send = async () => {
    ...
    const parts: UserPromptPart[] = artifactSelection
      ? [{ type: "artifact-reference", artifactId: artifactSelection.artifactId, kind: "presentation", name: artifactSelection.label, revision: artifactSelection.revision, surfaceId: artifactSelection.surfaceId, locator: artifactSelection.locator }, ...currentDraft.parts]
      : currentDraft.parts;
