...
import { ArrowUpRight, ChevronDown, ChevronRight, CircleHelp, Folder, Layers3, Mic, Pin, PinOff, Plus, Send, Square, X } from "lucide-react";
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <button className="flex min-w-0 flex-1 items-start gap-2 rounded-[6px] px-1.5 py-1.5 text-left" onClick={() => onInsertSkill(skill)} type="button">
                    <SkillIcon name={skill.name} className="mt-0.5 h-5 w-5 rounded-[5px] bg-[#f2f2ef] text-[#55554f] dark:bg-muted dark:text-muted-foreground" />
