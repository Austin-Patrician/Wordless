import { Check, CircleHelp, Copy, Lightbulb, ListChecks, MessageCircleQuestion } from "lucide-react";
...
function textFor(locale: "zh-CN" | "en-US"): LocalizedText {
  return locale === "zh-CN"
    ...
    : {
      ...
      goals: "Goals",
      implementList: "Implement the list",
      modeNext: "Next mode",
      no: "No",
