...
<ScreenshotFrame alt="Custom Provider and JSON model configuration" caption="Screenshot filename: settings/models-custom-provider.png. Show Provider ID, avatar, API key status, JSON editor, and Enabled models." />
